  ...
  return (
    <div className="admin-page">
      <div className="admin-head">
        <h1>Live sessions</h1>
        <Link href="/school/admin/sessions/new" className="btn btn-primary">New session</Link>
      </div>
      {sessions.length === 0 ? (
          ...
          <tbody>
            {sessions.map((s) => (
              <tr key={s.id}>
                ...
                <td><Link href={`/school/admin/sessions/${s.id}`} className="admin-link">{s.title}</Link></td>
