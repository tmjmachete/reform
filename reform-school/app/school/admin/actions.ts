...
export async function saveCourse(formData: FormData) {
  ...
  redirect(`/school/admin/courses/${courseId}`);
}
...
export async function createLesson(formData: FormData) {
  ...
  if (error) throw new Error(error.message);
  revalidatePath(`/school/admin/courses/${courseId}`);
  redirect(`/school/admin/courses/${courseId}/lessons/${(data as { id: string }).id}`);
}
...
export async function saveLesson(formData: FormData) {
  ...
  revalidatePath(`/school/admin/courses/${courseId}`);
  redirect(`/school/admin/courses/${courseId}/lessons/${id}`);
}
...
export async function addResource(formData: FormData) {
  ...
  revalidatePath(`/school/admin/courses/${courseId}/lessons/${lessonId}`);
  redirect(`/school/admin/courses/${courseId}/lessons/${lessonId}`);
}
...
export async function saveSession(formData: FormData) {
  ...
  revalidatePath('/school/admin/sessions');
  revalidatePath('/school/sessions');
...
export async function setCommentHidden(formData: FormData) {
  ...
  revalidatePath('/school/admin/comments');
}
