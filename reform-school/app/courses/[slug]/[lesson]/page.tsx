    ...
    <div className="lesson-shell">
      <article className="lesson-main">
        <div className="lesson-crumb">
          <Link href="/courses">Courses</Link> &nbsp;/&nbsp; <Link href={`/courses/${course.slug}`}>{course.title}</Link>
        </div>
        ...
        <div className="lesson-actions">
          ...
          <div className="lesson-nav-links">
            {prev && (
              <Link href={`/courses/${course.slug}/${prev.slug}`} className="btn btn-secondary">
                ← Previous
              </Link>
            )}
            {next && (
...
function LockedGate({ title }: { title: string }) {
  return (
    <div className="locked-gate">
      ...
      <Link href="/login" className="btn btn-primary">Sign in with Google</Link>
    </div>
  );
}
